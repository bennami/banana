 ...
 */
final class Version20200309133112 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, ticket_id_id INT DEFAULT NULL, commented_by_id INT DEFAULT NULL, timestamp DATETIME NOT NULL, type VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL, INDEX IDX_9474526C5774FDDC (ticket_id_id), INDEX IDX_9474526C94F6F716 (commented_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
